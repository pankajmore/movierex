...
public class SVM {
    ...
    public SVM() {
        try {
            BufferedReader reader = new BufferedReader(
                    new FileReader("C:/Users/Ankur/Desktop/ML Project/ml-100k/WrittenFilel_Normalized.arff"));
            ...
            for (int gammma = 0; gammma < 3; gammma++) {
                ...
                svm.setGamma(Math.pow(10, gammma));
                for (int cost = -8; cost < 11; cost = cost + 1) {
                    ...
                    eval.crossValidateModel(svm, trainData, 3, new Random(1));
    ...
    void CreateImage(Object arr[][], int degree) {
        ...
        try {
         ...
         //  int number=degree*10+bool;
            JFreeChart chart = ChartFactory.createLineChart("For Polynomial Degree ".concat(String.valueOf(degree)), "Cost Penalty", "Cross-Validation Error", line_chart_dataset, PlotOrientation.VERTICAL, true, true, true);
            ...
            int height = 480;
            File lineChart = new File(new String("Degree").concat(String.valueOf(degree)) + ".png");
