...
public class UserBased3 {
    ...
    void CreateImage(Object arr[][])
    {
         try {
                ...
                JFreeChart lineChartObject=ChartFactory.createLineChart("PearsonCorrelationSimilarity","Number_of_users","RMS Error",line_chart_dataset,PlotOrientation.VERTICAL,true,true,true);                
                          
                /* Step -3 : Write line chart to a file */               
                 int width=640; /* Width of the image */
                 int height=480; /* Height of the image */                
                 File lineChart=new File("C:/Users/Ankur/Desktop/User_based_PearsonCoeffiecintSimila.png");              
